...
describe('I18nService', () => {
  ...
  describe('init', () => {
    it('should init with setDefault language', () => {
      // Act
    ...
    it('should init with save language', () => {
      // Arrange
      const savedLanguage = 'it-IT';
      localStorage.setItem('language', savedLanguage);

      // Act
      i18nService.init(savedLanguage, supportedLanguages);
  ...
  describe('set language', () => {
    ...
    it('should change current language without a region match', () => {
      ...
      // Assert
      expect(translateService.use).toHaveBeenCalledWith('it-IT');
      expect(onLangChangeSpy).toHaveBeenCalledWith('it-IT');
    });

    it('should change current language to setDefault if unsupported', () => {
      // Arrange
