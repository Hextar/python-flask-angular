...
export class HttpService extends HttpClient {
  ...
  cache(forceUpdate?: boolean): HttpClient {
    ...
    return this._addInterceptor(cacheInterceptor);
  }

  skipErrorHandler(): HttpClient {
    return this._removeInterceptor(ErrorHandlerInterceptor);
  }

  disableApiPrefix(): HttpClient {
    return this._removeInterceptor(ApiPrefixInterceptor);
  }
  ...
  private _removeInterceptor(interceptorType: Type<HttpInterceptor>): HttpService {
  ...
  private _addInterceptor(interceptor: HttpInterceptor): HttpService {
    return new HttpService(
      this.httpHandler,
      this.injector,
